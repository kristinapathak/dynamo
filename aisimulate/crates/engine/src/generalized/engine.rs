...
use super::contracts::{
    ...
    EnginePassStarted, PassId, RankEffects, RankEngine, RankIdentity, RankPassStarted,
    SchedulerCommand,
};
...
impl<C: RankEngine> GeneralizedMockerEngine<C> {
    ...
    pub fn new(identity: EngineIdentity, config: EngineConfig<C::Config>) -> Result<Self> {
    ...
    pub fn apply_command_effects(
        ...
        // A command targets exactly one rank, and native schedulers use command
