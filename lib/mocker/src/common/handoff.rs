    ...
    pub fn validate(&self) -> Result<()> {
        aisimulate_replay::NormalizedHandoffConformance {
            engine_type: match self.engine_type {
                EngineType::Vllm => aisimulate_engine::NativeBackend::Vllm,
                EngineType::Sglang => aisimulate_engine::NativeBackend::Sglang,
                EngineType::Trtllm => aisimulate_engine::NativeBackend::Trtllm,
            },
            order: self.order,
    ...
    fn from(value: aisimulate_replay::NormalizedHandoffConformance) -> Self {
        Self {
            engine_type: match value.engine_type {
                aisimulate_engine::NativeBackend::Vllm => EngineType::Vllm,
                aisimulate_engine::NativeBackend::Sglang => EngineType::Sglang,
                aisimulate_engine::NativeBackend::Trtllm => EngineType::Trtllm,
            },
            order: value.order,
