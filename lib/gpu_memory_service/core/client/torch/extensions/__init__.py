...
try:
    from gpu_memory_service.core.client.torch.extensions import (  # noqa: F401
        _allocator_ext,
    )
    from gpu_memory_service.core.client.torch.extensions._allocator_ext import *  # noqa: F401, F403
except ImportError:
